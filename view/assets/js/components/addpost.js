export function addPost() {
    ...
    .then(data => {
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <form method="post" id="myForm">
                    ...
                    <textarea id="content2" name="content2" placeholder="Lorem Ipsum..." rows="6" maxlength="280" required></textarea>
        ...
        document.getElementById('myForm').addEventListener('submit', function(event) {
            ...
            var content = document.getElementById('content2').value.trim();
    ...
    .catch(error => {
        console.error('There was a problem with the fetch operation:', error);
        document.getElementById('content').innerHTML = '<p>Failed to load categories. Please try again later.</p>';
    });
}
